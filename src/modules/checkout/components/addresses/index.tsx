  ...
  return (
    <div className="">
      <div className="text-xl-semi flex items-center gap-x-4 px-8 pb-6 pt-8">
        ...
        <h2>{i.checkout.shipping_address}</h2>
      </div>
      {isEdit ? (
        <div className="px-8 pb-8">
          ...
          <div className="mt-6">
            <Checkbox
              label={i.checkout.same_as_billing}
              checked={checked}
              onChange={onChange}
            />
          </div>
          {!checked && (
            <div>
              <div className="text-xl-semi flex items-center gap-x-4 pb-6 pt-8">
                ...
                <h2>{i.checkout.billing_address}</h2>
              </div>
              <BillingAddress />
            </div>
          )}
        ...
        <div>
                  ...
                  <div className="flex flex-col">
                    ...
                    {checked && (
                      <div className="flex items-center gap-x-2 mt-6">
                        <div className="flex items-center justify-center border border-gray-700 bg-gray-900 w-4 h-4">
                          ✓
                        </div>
                        <span>{i.checkout.same_as_billing}</span>
                      </div>
                    )}
                  </div>
                  <div>
                    <button onClick={setEdit}>{i.common.edit}</button>
                  </div>
                </div>
              </div>
            ) : (
          ...
          {!checked && (
            <div>
              ...
              <div className="bg-gray-900 px-8 py-6 text-small-regular">
