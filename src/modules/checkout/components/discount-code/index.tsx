...
const DiscountCode: React.FC<DiscountCodeProps> = ({ cart }) => {
  ...
  return (
    <div className="w-max flex flex-col">
      <div className="mb-4">
        <h3 className="text-base-semi">{i.cart.discount}</h3>
      </div>
      <div className="text-small-regular">
        {appliedDiscount ? (
          <div className="flex items-center justify-between">
            <div>
              <span>{i.cart.code}: </span>
            ...
            <div>
              ...
              >
                <Trash size={16} />
                <span className="sr-only">{i.cart.remove_gift}</span>
              </button>
            </div>
          </div>
        ) : (
            ...
            <div className="grid grid-cols-[1fr_80px] gap-x-2">
              <Input
                ...
                {...register("discount_code", {
                  required: template(i.common.is_required, { field: i.cart.code }),
                })}
                errors={errors}
              />
              <div>
