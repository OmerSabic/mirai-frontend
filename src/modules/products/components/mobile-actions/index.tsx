    ...
    <>
      ...
      >
        <Transition
          ...
          leaveTo="opacity-0"
        >
          <div className="bg-black flex flex-col gap-y-3 justify-center items-center text-large-regular p-4 h-full w-full border-t border-gray-200">
                ...
                <div className="flex items-center justify-between w-full">
                  <span>
                    {variant
                      ...
                      : i.product.select_options}
                  </span>
                  <ChevronDown />
                </div>
              </Button>
              <Button onClick={addToCart}>{!inStock ? i.product.out_of_stock : i.product.add_to_cart}</Button>
            </div>
          </div>
        </Transition>
      </div>
              ...
              >
                <Dialog.Panel className="w-full h-full transform overflow-hidden text-left flex flex-col gap-y-3">
                  <div className="w-full flex justify-end pr-6">
                    <button
                      onClick={close}
                      className="bg-black w-12 h-12 rounded-full text-gray-100 flex justify-center items-center"
                    >
                      <X />
                    </button>
                  </div>
