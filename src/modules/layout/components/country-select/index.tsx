      ...
      >
        <Listbox.Button className="py-1 w-max">
          <div className="text-small-regular flex items-center gap-x-2 justify-end">
            <span>{i.footer.shipping_to}:</span>
            {current && (
        ...
        <div className="relative w-full min-w-[196px]">
          <Transition
            show={state}
            as={Fragment}
          ...
          >
            <Listbox.Options
              className="absolute -bottom-[calc(100%-36px)] left-0 xsmall:left-auto xsmall:right-0 max-h-[442px] overflow-y-scroll z-[900] bg-gray-900 drop-shadow-md text-small-regular uppercase text-white no-scrollbar"
              static
            >
              {options?.map((o) => {
                return (
