...
const PaymentDetails = ({ payments, paymentStatus }: PaymentDetailsProps) => {
  ...
  return (
    <div>
      <h2 className="text-base-semi">{i.checkout.payment}</h2>
      <div className="my-2">
        {payments.map((p) => {
...
const PayPalDetails = () => {
  return (
    <div className="flex flex-col text-base-regular">
      <span className="text-small-regular text-gray-200">PayPal</span>
...
const StripeDetails = ({ payment }: { payment: Payment }) => {
  ...
  return (
    <div className="flex flex-col text-base-regular">
      <span className="text-small-regular text-gray-200">
...
const TestDetails = () => {
  return (
    <div className="flex flex-col text-base-regular">
      <span className="text-small-regular text-gray-200">Test</span>
