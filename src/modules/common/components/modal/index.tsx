        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel
                className={clsx(
                  "w-full h-fit transform overflow-scroll bg-black p-10 text-left align-middle shadow-xl transition-all max-h-[65vh]",
                  {
                    "max-w-md": size === "small",
...
const Footer: React.FC = ({ children }) => {
  return <div className="flex items-center justify-end gap-x-4 pt-4">{children}</div>
}
